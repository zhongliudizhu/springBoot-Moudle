...
public class DateUtil {
     ...
     * @return Date
     */
    public static Date getDayBeginByDate(Date date) {
        Calendar currentDate = new GregorianCalendar();
     ...
     */
    public static String getNowDateStringMM() {
        Date currentTime = new Date();
    ...
    public static Date getYearsToday() throws ParseException {
        SimpleDateFormat adf = new SimpleDateFormat("yyyy-MM-dd");
        String dateStr = adf.format(new Date());
        return addDay(adf.parse(dateStr), -1);
    }
